...
export const requestPasswordReset = asyncHandler(async (req, res) => {
  ...
  return withTenantByCompanyCode(
    ...
    async () => {
      ...
      if (!account || account.status !== 'ACTIVE') {
        return res.json({
          ...
          message:
            'If the account is valid, the recovery process has been started.'
        });
      }
      ...
      if (account.role === 'SUPER_ADMIN') {
        ...
        return res.json({
          ...
          message:
            'An OTP was sent to the authorised Super Admin email.'
        });
      }
    ...
    return withTenantByCompanyCode(
      ...
      async () => {
        ...
        return res.json({
          success: true,
          message:
            'Super Admin password reset successfully. Sign in using the authorised email.'
        });
      }
    );
  }
