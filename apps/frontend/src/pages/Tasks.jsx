...
export default function Tasks() {
  const { user } = useAuth();
  const canManage = taskAdminRoles.includes(user?.role);
  ...
  async function removeTask(task) {
    if (!window.confirm(`Delete assigned work "${task.title}"? This action cannot be undone.`)) return;
