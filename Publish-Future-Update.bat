...
echo ======================================================
echo.
set /p VERSION=Enter new version (example 1.1.1): 
...
git add package.json package-lock.json apps .github scripts Build-SRSB-v1.1.0.bat Publish-Future-Update.bat README-V1.1.0.md
